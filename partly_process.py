...
def cache_inverted_index():
    f = open("inverted_index_1.json", "w", encoding='utf8')
    f.write(json.dumps(inverted_index))
    f.close()

    f = open("titles_1.json", "w", encoding='utf8')
    f.write(json.dumps(docs_title))
    f.close()

    f = open("urls_1.json", "w", encoding='utf8')
...
def read_inverted_index_from_cache():
    ...
    global docs_title
    global docs_url
    f = open('inverted_index_1.json', encoding='utf8')
    inverted_index = json.load(f)

    f = open('titles_1.json', encoding='utf8')
    docs_title = json.load(f)

    f = open('urls_1.json', encoding='utf8')
